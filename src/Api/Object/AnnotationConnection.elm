...
module Api.Object.AnnotationConnection exposing (..)
...
edges :
    SelectionSet decodesTo Api.Object.AnnotationEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.Object.AnnotationConnection
edges object_ =
